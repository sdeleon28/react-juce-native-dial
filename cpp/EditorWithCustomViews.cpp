#include "EditorWithCustomViews.h"

EditorWithCustomViews::EditorWithCustomViews (juce::AudioProcessor& proc, const juce::File& bundle)
...
void EditorWithCustomViews::registerViewType(const juce::String & typeId, ViewManager::ViewFactory f)
{
    appRoot.registerViewType(typeId, f);
}

void EditorWithCustomViews::start()
{
#if JUCE_DEBUG
...
EditorWithCustomViews::~EditorWithCustomViews()
{
...
//==============================================================================
void EditorWithCustomViews::parameterValueChanged (int parameterIndex, float newValue)
{
...
void EditorWithCustomViews::parameterGestureChanged (int, bool)
{
...
//==============================================================================
void EditorWithCustomViews::timerCallback()
{
...
//==============================================================================
void EditorWithCustomViews::resized()
{
...
void EditorWithCustomViews::paint(juce::Graphics& g)
{
    g.fillAll(juce::Colours::transparentWhite);
}

//==============================================================================
void EditorWithCustomViews::beforeBundleEvaluated()
{
...
void EditorWithCustomViews::afterBundleEvaluated()
{
